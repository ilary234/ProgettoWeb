    ...
    <div class="row">
        <nav class="col-12">
            <ul class="row nav text-center">
                <li class="nav-item col-4"><a class="nav-link" href="infoGruppo.php?nomeGruppo=<?php echo $templateParams["nomeGruppo"]?>&admin=<?php echo $templateParams["admin"]?>">Info</a></li>
                <li class="nav-item col-4"><a class="nav-link attivo" href="#">Materiale</a></li>
                <li class="nav-item col-4"><a style="border-right: 0px;" class="nav-link disiscriviti" href="#">Disiscriviti</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<div class="modal fade" id="confermaAzione" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="confermaAzioneLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Sei sicuro di volerti Disiscrivere?</p>
      </div>
      <div class="modal-footer">
