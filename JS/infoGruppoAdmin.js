...
document.getElementById("edit").addEventListener("click", () => window.location.href = `modificaGruppo.php?nomeGruppo=${urlParams.get('nomeGruppo')}&admin=${urlParams.get('admin')}`);
